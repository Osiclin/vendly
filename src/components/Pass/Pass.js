...
export default function Pass() {
    return(
        <div style={{padding: '1.5rem'}}>
            ...
            <div style={{width: '289px', height: '161px', backgroundColor: '#E0FAF8', display: 'flex', alignItems: 'center', marginBottom: '2.125rem'}}>
